...
namespace Application.Followers
{
    public class Delete
    {
        ...
        public class Handler : IRequestHandler<Command>
        {
            ...
            {
                var observer = await _context.Users.SingleOrDefaultAsync(xx => xx.UserName == _userAccessor.GetCurrentUsername());

                var target = await _context.Users.SingleOrDefaultAsync(xx => xx.UserName == request.Username);
